...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(167809980695663118)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167810201134663121)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167810546342663121)
,p_plugin_attribute_id=>wwv_flow_imp.id(167810201134663121)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167810960160663122)
,p_plugin_attribute_id=>wwv_flow_imp.id(167810201134663121)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167811307837663122)
,p_plugin_attribute_id=>wwv_flow_imp.id(167810201134663121)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167811754681663122)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(167810201134663121)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167812013104663123)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167812352096663123)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167812624252663123)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167812985032663124)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167813202639663124)
,p_plugin_attribute_id=>wwv_flow_imp.id(167812985032663124)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167813677808663125)
,p_plugin_attribute_id=>wwv_flow_imp.id(167812985032663124)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167814051550663125)
,p_plugin_attribute_id=>wwv_flow_imp.id(167812985032663124)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167814498843663125)
,p_plugin_attribute_id=>wwv_flow_imp.id(167812985032663124)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167814812225663126)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167815154415663126)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167815585736663126)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167815974187663127)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167816333161663127)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167816710089663128)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167817182279663128)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167817503986663128)
,p_plugin_attribute_id=>wwv_flow_imp.id(167814812225663126)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167817905827663129)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1967860818654776872)
,p_plugin_id=>wwv_flow_imp.id(167809980695663118)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
