...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(167865365033663209)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1967883748147546861)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1967883193135546860)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167866021398663213)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167866319609663214)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167866690334663214)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167866957850663214)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167867270998663215)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(167866690334663214)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1967883748147546861)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167867550191663215)
,p_plugin_attribute_id=>wwv_flow_imp.id(167867270998663215)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167867914347663216)
,p_plugin_attribute_id=>wwv_flow_imp.id(167867270998663215)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167868315261663216)
,p_plugin_attribute_id=>wwv_flow_imp.id(167867270998663215)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167868783968663217)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(167867270998663215)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167869017127663217)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167869308764663218)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167869621258663218)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167869961455663218)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167870221962663219)
,p_plugin_attribute_id=>wwv_flow_imp.id(167869961455663218)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167870602034663219)
,p_plugin_attribute_id=>wwv_flow_imp.id(167869961455663218)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167871090181663220)
,p_plugin_attribute_id=>wwv_flow_imp.id(167869961455663218)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167871460267663220)
,p_plugin_attribute_id=>wwv_flow_imp.id(167869961455663218)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167871851510663221)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(167866957850663214)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1967883193135546860)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167872183865663221)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167872457108663221)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167872777426663222)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167873015120663222)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167873373393663222)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167873652319663223)
,p_plugin_attribute_id=>wwv_flow_imp.id(167873373393663222)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167874061503663223)
,p_plugin_attribute_id=>wwv_flow_imp.id(167873373393663222)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167874419663663224)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167874737669663224)
,p_plugin_attribute_id=>wwv_flow_imp.id(167874419663663224)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167875186305663225)
,p_plugin_attribute_id=>wwv_flow_imp.id(167874419663663224)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167875592223663225)
,p_plugin_attribute_id=>wwv_flow_imp.id(167874419663663224)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167875926205663225)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167876280735663226)
,p_plugin_attribute_id=>wwv_flow_imp.id(167875926205663225)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167876663021663226)
,p_plugin_attribute_id=>wwv_flow_imp.id(167875926205663225)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167877043618663227)
,p_plugin_attribute_id=>wwv_flow_imp.id(167875926205663225)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167877445905663228)
,p_plugin_attribute_id=>wwv_flow_imp.id(167875926205663225)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167877851193663228)
,p_plugin_attribute_id=>wwv_flow_imp.id(167875926205663225)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167878243491663229)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(167878587144663229)
,p_plugin_attribute_id=>wwv_flow_imp.id(167878243491663229)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(167878981721663230)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1968086800304693489)
,p_plugin_id=>wwv_flow_imp.id(167865365033663209)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
