...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(167652483284662985)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167652795288662986)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167653073250662986)
,p_page_template_id=>wwv_flow_imp.id(167652483284662985)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167653315177662986)
,p_page_template_id=>wwv_flow_imp.id(167652483284662985)
