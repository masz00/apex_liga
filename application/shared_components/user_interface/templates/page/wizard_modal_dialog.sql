...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(167661021582662993)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167661306853662994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167661697317662994)
,p_page_template_id=>wwv_flow_imp.id(167661021582662993)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167661915902662994)
,p_page_template_id=>wwv_flow_imp.id(167661021582662993)
