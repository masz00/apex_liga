...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(167631842309662964)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167632100751662965)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167632463881662965)
,p_page_template_id=>wwv_flow_imp.id(167631842309662964)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167632712414662966)
,p_page_template_id=>wwv_flow_imp.id(167631842309662964)
