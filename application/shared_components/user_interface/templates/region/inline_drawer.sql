...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167714592989663037)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167714883943663037)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167715173191663037)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167715411097663038)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167715702181663038)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167716088416663038)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167716321394663039)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167716637828663039)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167716994714663039)
,p_plug_template_id=>wwv_flow_imp.id(167714592989663037)
,p_name=>'Sub Regions'
