...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167667717117663000)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167668054910663000)
,p_plug_template_id=>wwv_flow_imp.id(167667717117663000)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167668306376663001)
,p_plug_template_id=>wwv_flow_imp.id(167667717117663000)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167668691827663001)
,p_plug_template_id=>wwv_flow_imp.id(167667717117663000)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167668952819663001)
,p_plug_template_id=>wwv_flow_imp.id(167667717117663000)
,p_name=>'Sub Regions'
