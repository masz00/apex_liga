...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167709992716663033)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167710231753663034)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167710545134663034)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167710884112663034)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167711181229663034)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167711472775663034)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167711789179663035)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167712039073663035)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167712332683663035)
,p_plug_template_id=>wwv_flow_imp.id(167709992716663033)
,p_name=>'Sub Regions'
