...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167744153312663061)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167744465070663061)
,p_plug_template_id=>wwv_flow_imp.id(167744153312663061)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167744700955663061)
,p_plug_template_id=>wwv_flow_imp.id(167744153312663061)
,p_name=>'Tabs'
