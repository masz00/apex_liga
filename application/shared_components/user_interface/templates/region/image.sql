...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167704527373663029)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167704870650663029)
,p_plug_template_id=>wwv_flow_imp.id(167704527373663029)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167705138906663030)
,p_plug_template_id=>wwv_flow_imp.id(167704527373663029)
,p_name=>'Sub Regions'
