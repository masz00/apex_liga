...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167719137793663041)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167719474026663041)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167719745970663041)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167720059941663042)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167720321607663042)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167720698112663042)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167720921435663042)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167721299579663042)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167721538501663043)
,p_plug_template_id=>wwv_flow_imp.id(167719137793663041)
,p_name=>'Sub Regions'
