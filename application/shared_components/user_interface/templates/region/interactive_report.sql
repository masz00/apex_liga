...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167724540842663045)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167724847102663045)
,p_plug_template_id=>wwv_flow_imp.id(167724540842663045)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167725128848663046)
,p_plug_template_id=>wwv_flow_imp.id(167724540842663045)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167725455466663046)
,p_plug_template_id=>wwv_flow_imp.id(167724540842663045)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167725757908663046)
,p_plug_template_id=>wwv_flow_imp.id(167724540842663045)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167726052492663046)
,p_plug_template_id=>wwv_flow_imp.id(167724540842663045)
,p_name=>'Sub Regions'
