...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167729193142663048)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167729493103663049)
,p_plug_template_id=>wwv_flow_imp.id(167729193142663048)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167729700269663049)
,p_plug_template_id=>wwv_flow_imp.id(167729193142663048)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167730065784663049)
,p_plug_template_id=>wwv_flow_imp.id(167729193142663048)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167730349962663049)
,p_plug_template_id=>wwv_flow_imp.id(167729193142663048)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167730608680663050)
,p_plug_template_id=>wwv_flow_imp.id(167729193142663048)
,p_name=>'Sub Regions'
