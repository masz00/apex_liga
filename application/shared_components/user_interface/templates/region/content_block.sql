...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167696451163663023)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167696741607663023)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167697076980663023)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167697375548663023)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167697642855663024)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167697923873663024)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167698293866663024)
,p_plug_template_id=>wwv_flow_imp.id(167696451163663023)
,p_name=>'Sub Regions'
