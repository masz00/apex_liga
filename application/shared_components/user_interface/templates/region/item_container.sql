...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167726664172663047)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167726979181663047)
,p_plug_template_id=>wwv_flow_imp.id(167726664172663047)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167727295943663047)
,p_plug_template_id=>wwv_flow_imp.id(167726664172663047)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167727570576663047)
,p_plug_template_id=>wwv_flow_imp.id(167726664172663047)
,p_name=>'Button Start'
