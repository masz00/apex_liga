...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167669144131663001)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167669445353663001)
,p_plug_template_id=>wwv_flow_imp.id(167669144131663001)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167669760243663002)
,p_plug_template_id=>wwv_flow_imp.id(167669144131663001)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167670079254663002)
,p_plug_template_id=>wwv_flow_imp.id(167669144131663001)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167670317188663002)
,p_plug_template_id=>wwv_flow_imp.id(167669144131663001)
,p_name=>'Sub Regions'
