...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167751855411663068)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167752147860663069)
,p_plug_template_id=>wwv_flow_imp.id(167751855411663068)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167752434660663069)
,p_plug_template_id=>wwv_flow_imp.id(167751855411663068)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167752783234663069)
,p_plug_template_id=>wwv_flow_imp.id(167751855411663068)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167753063712663069)
,p_plug_template_id=>wwv_flow_imp.id(167751855411663068)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167753321079663069)
,p_plug_template_id=>wwv_flow_imp.id(167751855411663068)
