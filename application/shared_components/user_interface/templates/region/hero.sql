...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167701082599663026)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167701338228663027)
,p_plug_template_id=>wwv_flow_imp.id(167701082599663026)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167701680129663027)
,p_plug_template_id=>wwv_flow_imp.id(167701082599663026)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167701947563663027)
,p_plug_template_id=>wwv_flow_imp.id(167701082599663026)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167702294396663027)
,p_plug_template_id=>wwv_flow_imp.id(167701082599663026)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167702559202663028)
,p_plug_template_id=>wwv_flow_imp.id(167701082599663026)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
