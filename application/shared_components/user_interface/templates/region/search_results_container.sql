...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(167731605285663050)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167731932039663051)
,p_plug_template_id=>wwv_flow_imp.id(167731605285663050)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167732252049663051)
,p_plug_template_id=>wwv_flow_imp.id(167731605285663050)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(167732545849663051)
,p_plug_template_id=>wwv_flow_imp.id(167731605285663050)
,p_name=>'Sub Regions'
